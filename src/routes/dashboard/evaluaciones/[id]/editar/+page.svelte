...
{:else}
	<div class="space-y-6 p-6">
		...
		<div class="flex items-center justify-between">
			<div>
				<h1 class="text-3xl font-bold text-gray-900">Editar Evaluación</h1>
				<p class="text-gray-600">Modifica el título, preguntas y opciones de respuesta</p>
			</div>
			<button
				on:click={() => goto(`/dashboard/evaluaciones/${evaluacionId}`)}
		...
		<div class="flex justify-end gap-4">
			...
			>
				{isSubmitting ? 'Actualizando...' : 'Actualizar Evaluación'}
			</button>
		</div>
	</div>
{/if}

<!-- Modal para agregar/editar pregunta (igual que en crear) -->
{#if showPreguntaForm}
