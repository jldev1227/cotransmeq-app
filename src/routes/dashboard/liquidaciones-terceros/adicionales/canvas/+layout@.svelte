<!--
	+layout@.svelte — layout reset para la page Univer de **Adicionales
	de cierres finales de terceros**.
...
<UniverAuthGuard moduleId="liquidaciones-terceros-adicionales">
	<UniverShell>
		{@render children()}
	</UniverShell>
</UniverAuthGuard>