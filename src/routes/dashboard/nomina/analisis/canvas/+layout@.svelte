<!--
	+layout@.svelte — layout reset para el canvas de **análisis de nómina**.

	Aquí NO se monta ningún motor de Univer: análisis son gráficas de
	`chart.js` y tablas. Se usa la misma cáscara porque `UniverShell` es solo
