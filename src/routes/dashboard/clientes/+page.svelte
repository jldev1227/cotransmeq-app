		...
		<div class="flex flex-col items-start justify-between gap-6 lg:flex-row lg:items-center">
					...
					>
						...
						>
							{#each clientesFiltrados as cliente (cliente.id)}
								<div class="glass relative flex flex-col rounded-2xl border border-gray-200/50 p-6">
									<!-- ...existing card content... -->
									<div class="absolute top-3 right-3 z-10">
										<div class="relative">
											<button
												class="apple-transition rounded-full p-2 hover:bg-gray-100"
											...
											>
												<svg
													...
													><circle cx="12" cy="12" r="1.5" /><circle
														...
														cy="12"
														r="1.5"
													/><circle cx="4.5" cy="12" r="1.5" /></svg
												>
											</button>
											{#if cliente.showDropdown}
												<div
													class="absolute right-0 bottom-full mb-1 w-40 rounded-xl border border-gray-200 bg-white py-2 shadow-xl"
												>
													<button
			...
			<div class="flex flex-col gap-3 sm:flex-row">
				...
				<div class="group relative">
					...
					>
						{mostrarOcultos ? 'Ver clientes activos' : 'Ver clientes ocultos'}
					</div>
				</div>
