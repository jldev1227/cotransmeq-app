...
<div class="idm-backdrop">
	<div class="idm" role="dialog" aria-modal="true" aria-labelledby="idm-titulo">
		<div class="idm-head">
			<div>
				<h2 id="idm-titulo">
					Traer items al ocasional de {periodo}
					{#if consecutivo}<span class="idm-cons">{consecutivo}</span>{/if}
				</h2>
				<p class="idm-sub">
					Items facturados que siguen sueltos, de cualquier mes: ni en un cierre de placa
					ni en otro ocasional
				</p>
				...
				{#if !cargando && (descartadosCierre > 0 || descartadosOcasional > 0)}
