	...
	>
		...
		>
			...
			<div class="flex items-center gap-3 border-b border-gray-100 p-5">
				<div class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600">
			...
			<div class="space-y-3 border-b border-gray-100 p-5">
				...
				<div class="relative">
					...
					<input
						...
						class="input-glow apple-transition w-full rounded-xl border border-gray-200 bg-white py-2 pr-4 pl-9 text-sm text-gray-900 placeholder-gray-400 focus:border-emerald-400"
					/>
				</div>
				...
				{:else}
					<div class="space-y-1">
						{#if terceros.length > 1}
							<button
								class="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left text-xs font-medium text-emerald-700 hover:bg-emerald-50"
								on:click={toggleAll}
								type="button"
							>
			...
			<div class="flex items-center justify-between gap-2 border-t border-gray-100 bg-gray-50/50 p-4">
				...
				<div class="flex items-center gap-2">
					...
					<button
						class="apple-transition rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:from-emerald-600 hover:to-emerald-700 disabled:cursor-not-allowed disabled:opacity-50"
